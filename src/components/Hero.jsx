...
import heroVideo from '../AmalFolder/AmalVideo/Amal-hero.mp4';
import heroPoster from '../AmalFolder/AmalHero.png';
      ...
      <div className="absolute inset-0 z-20 px-6 pb-20 md:pb-[8%] md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row justify-end md:justify-between items-start md:items-end text-left w-full">
        ...
        <div className="flex flex-col items-start text-left max-w-2xl w-full">
          ...
          <p 
            data-aos="fade-up"
            data-aos-delay="200"
            className="text-sm md:text-lg font-semibold mb-8 max-w-md text-white drop-shadow-md"
          >
          ...
          >
            ...
            <a 
              ...
              className="px-4 py-2 md:px-6 md:py-2 text-xs md:text-base rounded-full backdrop-blur-md font-semibold bg-black/40 border border-white text-white hover:bg-black/60 transition-all duration-300"
            >
            ...
            <a 
              ...
              download
              className="px-4 py-2 md:px-6 md:py-2 text-xs md:text-base rounded-full backdrop-blur-md flex items-center gap-2 font-semibold bg-transparent border border-white/50 text-white hover:bg-white hover:text-black transition-all duration-300"
            >
        ...
        <div 
          ...
          onClick={toggleVideo}
        >
          <div className="w-12 h-12 md:w-20 md:h-20 rounded-full bg-black/20 backdrop-blur-md flex justify-center items-center group-hover:scale-110 group-hover:bg-[#ff2a2a] transition-all duration-300 border border-white/30">
            {!isPlaying ? (
              // Play Icon
              <svg className="w-5 h-5 md:w-8 md:h-8 ml-0.5 md:ml-1 text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <span className="text-[10px] md:text-xs font-bold tracking-widest uppercase opacity-70 group-hover:opacity-100 transition-all duration-300 text-white">
