...
const Footer = () => {
  return (
    <footer className="bg-[#111111] text-[#d4d4d4] py-16 px-6 md:px-12 w-full font-mono text-[10px] md:text-xs tracking-widest flex flex-col justify-between min-h-[50vh]">
      ...
      {/* Middle Huge Text */}
      <div className="w-full flex justify-center items-center py-10 md:py-20 lg:py-24 overflow-hidden">
        <h2 className="text-[22vw] sm:text-[18vw] md:text-[16vw] leading-none font-sans font-bold tracking-tighter lowercase select-none text-[#f4f4f4] w-full text-center">
