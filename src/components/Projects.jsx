      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div data-aos="fade-up" data-aos-delay="500" className="mt-16 flex justify-center">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 md:gap-3 px-5 md:px-8 py-3 md:py-4 rounded-full border border-white/20 text-white font-bold text-sm md:text-lg hover:bg-white hover:text-black hover:shadow-[0_0_30px_rgba(255,255,255,0.15)] transition-all duration-500 group text-center"
          >
            <GitHubIcon />
            <span className="hidden sm:inline">Explore All My Repositories</span>
